...
<head>
	...
	<link rel="stylesheet" type="text/css" href="searchbox/style.css">
	<script type="text/javascript" src="searchbox/function.js"></script>
</head>
<body>
	<ul class="top-nav">
...
<input type="text" id="myInput" onkeyup="myFunction()" placeholder="Search FirstName...">
